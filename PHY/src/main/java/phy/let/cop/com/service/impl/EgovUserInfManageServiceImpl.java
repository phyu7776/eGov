...
import phy.let.cop.com.service.EgovUserInfManageService;
import phy.let.cop.com.service.UserInfVO;
...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(phy.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectClubUserList(phy.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(phy.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(phy.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectUserList(phy.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(phy.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see phy.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(phy.let.cop.com.service.UserInfVO)
     */
